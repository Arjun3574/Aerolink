...
import { Map, Overlay, Marker, ZoomControl } from "pigeon-maps";
...
export default function SituationalMap({ tickets, baseCoord, height = 320 }: { tickets: any[]; baseCoord: {lat: number, lng: number} | null; height?: number }) {
  ...
  useEffect(() => {
    if (baseCoord && center[0] === 18.5204) setCenter([baseCoord.lat, baseCoord.lng]);
  }, [baseCoord]);
